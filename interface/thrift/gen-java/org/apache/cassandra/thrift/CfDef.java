...
public class CfDef implements org.apache.thrift.TBase<CfDef, CfDef._Fields>, java.io.Serializable, Cloneable {
  ...
  public Map<String,String> triggers; // optional
  /**
   * @deprecated
   */
...
;
    ...
    if (other.isSetTriggers()) {
      Map<String,String> __this__triggers = new HashMap<String,String>();
      for (Map.Entry<String, String> other_element : other.triggers.entrySet()) {
        ...
        String __this__triggers_copy_value = other_element_value;
  ...
  public void putToTriggers(String key, String val) {
  ...
  public CfDef setTriggers(Map<String,String> triggers) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TRIGGERS:
      if (value == null) {
        ...
        setTriggers((Map<String,String>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.triggers = new HashMap<String,String>(2*_map103.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CfDef struct) throws org.apache.thrift.TException {
      ...
      if (struct.column_metadata != null) {
        if (struct.isSetColumn_metadata()) {
          oprot.writeFieldBegin(COLUMN_METADATA_FIELD_DESC);
          {
            ...
            for (ColumnDef _iter107 : struct.column_metadata)
            {
      ...
      if (struct.compaction_strategy_options != null) {
        if (struct.isSetCompaction_strategy_options()) {
          oprot.writeFieldBegin(COMPACTION_STRATEGY_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter108 : struct.compaction_strategy_options.entrySet())
            {
      ...
      if (struct.compression_options != null) {
        if (struct.isSetCompression_options()) {
          oprot.writeFieldBegin(COMPRESSION_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter109 : struct.compression_options.entrySet())
            {
      ...
      if (struct.triggers != null) {
        if (struct.isSetTriggers()) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.triggers.size()));
            for (Map.Entry<String, String> _iter110 : struct.triggers.entrySet())
            {
      ...
      if (struct.isSetTriggers()) {
        {
          ...
          for (Map.Entry<String, String> _iter114 : struct.triggers.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.column_metadata = new ArrayList<ColumnDef>(_list115.size);
          for (int _i116 = 0; _i116 < _list115.size; ++_i116)
          {
            ColumnDef _elem117; // optional
            _elem117 = new ColumnDef();
            _elem117.read(iprot);
            struct.column_metadata.add(_elem117);
          }
        }
        struct.setColumn_metadataIsSet(true);
      }
      ...
      if (incoming.get(15)) {
        {
          ...
          struct.compaction_strategy_options = new HashMap<String,String>(2*_map118.size);
          for (int _i119 = 0; _i119 < _map118.size; ++_i119)
          {
            ...
            struct.compaction_strategy_options.put(_key120, _val121);
          }
        }
        struct.setCompaction_strategy_optionsIsSet(true);
      }
      if (incoming.get(16)) {
        {
          ...
          struct.compression_options = new HashMap<String,String>(2*_map122.size);
          for (int _i123 = 0; _i123 < _map122.size; ++_i123)
          {
            ...
            struct.compression_options.put(_key124, _val125);
          }
        }
        struct.setCompression_optionsIsSet(true);
      }
      ...
      if (incoming.get(25)) {
        {
          ...
          struct.triggers = new HashMap<String,String>(2*_map126.size);
          for (int _i127 = 0; _i127 < _map126.size; ++_i127)
          {
            ...
            struct.triggers.put(_key128, _val129);
          }
        }
        struct.setTriggersIsSet(true);
      }
