            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.name_types = new HashMap<ByteBuffer,String>(2*_map164.size);
                for (int _i165 = 0; _i165 < _map164.size; ++_i165)
                {
                  ...
                  struct.name_types.put(_key166, _val167);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.value_types = new HashMap<ByteBuffer,String>(2*_map168.size);
                for (int _i169 = 0; _i169 < _map168.size; ++_i169)
                {
                  ...
                  struct.value_types.put(_key170, _val171);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CqlMetadata struct) throws org.apache.thrift.TException {
      ...
      if (struct.name_types != null) {
        oprot.writeFieldBegin(NAME_TYPES_FIELD_DESC);
        {
          ...
          for (Map.Entry<ByteBuffer, String> _iter172 : struct.name_types.entrySet())
          {
      ...
      if (struct.value_types != null) {
        oprot.writeFieldBegin(VALUE_TYPES_FIELD_DESC);
        {
          ...
          for (Map.Entry<ByteBuffer, String> _iter173 : struct.value_types.entrySet())
          {
            oprot.writeBinary(_iter173.getKey());
  ...
  private static class CqlMetadataTupleScheme extends TupleScheme<CqlMetadata> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CqlMetadata struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.name_types = new HashMap<ByteBuffer,String>(2*_map176.size);
        for (int _i177 = 0; _i177 < _map176.size; ++_i177)
        {
          ...
          struct.name_types.put(_key178, _val179);
        }
      }
      struct.setName_typesIsSet(true);
      {
        ...
        struct.value_types = new HashMap<ByteBuffer,String>(2*_map180.size);
        for (int _i181 = 0; _i181 < _map180.size; ++_i181)
        {
          ByteBuffer _key182; // required
          String _val183; // required
          _key182 = iprot.readBinary();
          _val183 = iprot.readString();
          struct.value_types.put(_key182, _val183);
        }
      }
      struct.setValue_typesIsSet(true);
      struct.default_name_type = iprot.readString();
