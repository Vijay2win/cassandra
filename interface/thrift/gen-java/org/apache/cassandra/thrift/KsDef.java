            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.strategy_options = new HashMap<String,String>(2*_map130.size);
                for (int _i131 = 0; _i131 < _map130.size; ++_i131)
                {
                  ...
                  struct.strategy_options.put(_key132, _val133);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cf_defs = new ArrayList<CfDef>(_list134.size);
                for (int _i135 = 0; _i135 < _list134.size; ++_i135)
                {
                  CfDef _elem136; // optional
                  _elem136 = new CfDef();
                  _elem136.read(iprot);
                  struct.cf_defs.add(_elem136);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, KsDef struct) throws org.apache.thrift.TException {
      ...
      if (struct.strategy_options != null) {
        if (struct.isSetStrategy_options()) {
          oprot.writeFieldBegin(STRATEGY_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter137 : struct.strategy_options.entrySet())
            {
      ...
      if (struct.cf_defs != null) {
        oprot.writeFieldBegin(CF_DEFS_FIELD_DESC);
        {
          ...
          for (CfDef _iter138 : struct.cf_defs)
          {
  ...
  private static class KsDefTupleScheme extends TupleScheme<KsDef> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, KsDef struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.strategy_class);
      {
        ...
        for (CfDef _iter139 : struct.cf_defs)
        {
      ...
      if (struct.isSetStrategy_options()) {
        {
          ...
          for (Map.Entry<String, String> _iter140 : struct.strategy_options.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, KsDef struct) throws org.apache.thrift.TException {
      ...
      struct.setStrategy_classIsSet(true);
      {
        ...
        struct.cf_defs = new ArrayList<CfDef>(_list141.size);
        for (int _i142 = 0; _i142 < _list141.size; ++_i142)
        {
          CfDef _elem143; // optional
          _elem143 = new CfDef();
          _elem143.read(iprot);
          struct.cf_defs.add(_elem143);
        }
      }
      struct.setCf_defsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.strategy_options = new HashMap<String,String>(2*_map144.size);
          for (int _i145 = 0; _i145 < _map144.size; ++_i145)
          {
            ...
            struct.strategy_options.put(_key146, _val147);
          }
        }
        struct.setStrategy_optionsIsSet(true);
      }
