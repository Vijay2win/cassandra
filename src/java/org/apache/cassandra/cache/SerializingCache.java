...
public class SerializingCache<K, V> implements ICache<K, V>
{
    ...
    private static final DBConstants encodedConstants = new EncodedDataOutputStream.EncodedDBConstant();
    ...
    {
        long serializedSize = serializer.serializedSize(value, encodedConstants);
