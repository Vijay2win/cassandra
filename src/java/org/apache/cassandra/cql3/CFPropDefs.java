...
public class CFPropDefs extends PropertyDefinitions
{
    ...
    public static final String KW_TRIGGER_CLASSES = "trigger_classes";
    ...
    static
    {
        ...
        keywords.add(KW_TRIGGER_CLASSES);
    ...
    public void applyToCFMetadata(CFMetaData cfm) throws ConfigurationException, SyntaxException
    {
        ...
        cfm.triggerClasses(getSet(KW_TRIGGER_CLASSES, cfm.getTriggerClasses()));
