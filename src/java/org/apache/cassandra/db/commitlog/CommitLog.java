...
public class CommitLog implements CommitLogMBean
{
    ...
    {
        long totalSize = RowMutation.serializer().serializedSize(rm, SerializationFactory.get(MessagingService.VERSION_11).getDBTypeSizes(), MessagingService.VERSION_11) + CommitLogSegment.ENTRY_OVERHEAD_SIZE;
