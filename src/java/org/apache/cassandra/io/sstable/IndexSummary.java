...
public class IndexSummary implements Closeable
{
    ...
    private final long block_start;
    private final int summary_size;
    private final Memory bytes;

    public IndexSummary(IPartitioner partitioner, Memory memory, long block_start, int summary_size, int indexInterval)
    {
    ...
    public int getIndex(int index)
    {
        ...
        return bytes.getInt(block_start + (index << 2));
    }
    ...
    {
        return index == (summary_size - 1) ? block_start : getIndex(index + 1);
    }
    ...
    public static class IndexSummarySerializer
    {
        ...
        public IndexSummary deserialize(DataInputStream in, IPartitioner partitioner) throws IOException
        {
            ...
            return new IndexSummary(partitioner, memory, block_start, summary_size, indexInterval);
        }
    }
