...
public class SSTableSimpleUnsortedWriter extends AbstractSSTableSimpleWriter
{
    ...
    {
        currentSize += key.key.remaining() + ColumnFamily.serializer.serializedSize(columnFamily, DBConstants.nativeConstants) * 1.2;
    ...
    protected ColumnFamily getColumnFamily()
    {
        ...
        else
        {
            ...
            currentSize -= currentKey.key.remaining() + ColumnFamily.serializer.serializedSize(previous, DBConstants.nativeConstants) * 1.2;
        }
        return previous;
    }
