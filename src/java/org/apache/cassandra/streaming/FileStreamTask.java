...
import org.apache.cassandra.io.util.DataIntegratyMetadata;
import org.apache.cassandra.io.util.DataIntegratyMetadata.ChecksumValidator;
...
public class FileStreamTask extends WrappedRunnable
{
    ...
    protected void stream() throws IOException
    {
        ...
        if (new File(desc.filenameFor(Component.CRC)).exists())
            metadata = DataIntegratyMetadata.checksumValidator(desc);
