...
import com.tinkerpop.thrift.Message;
import com.tinkerpop.thrift.TDisruptorServer;
import org.apache.cassandra.config.DatabaseDescriptor;
import org.apache.cassandra.thrift.TServerFactory.Args;
import org.apache.thrift.server.TServer;
import org.apache.thrift.transport.TNonblockingServerTransport;
import org.apache.thrift.transport.TNonblockingSocket;
import org.apache.thrift.transport.TTransportException;

public class CustomTDisruptorServer extends TDisruptorServer
{
    private static final Logger logger = LoggerFactory.getLogger(CustomTDisruptorServer.class.getName());
    ...
    public static class Factory implements TServerFactory
    {
        public TServer buildTServer(Args args)
        {
            ...
            com.tinkerpop.thrift.util.TBinaryProtocol.Factory protocolFactory = new com.tinkerpop.thrift.util.TBinaryProtocol.Factory(true, true, DatabaseDescriptor.getThriftMaxMessageLength());
            ...
            return new CustomTDisruptorServer(serverArgs);
        }
    }
}
