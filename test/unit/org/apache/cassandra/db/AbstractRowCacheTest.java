...
public abstract class AbstractRowCacheTest
{
    ...
    protected static boolean isTestAvailable = FBUtilities.isUnix();

    public static void defineSchema(ICacheProvider provider) throws ConfigurationException
    {
        DatabaseDescriptor.setRowCacheProvider(provider);
    ...
    public void testRowCacheCleanup() throws Exception
    {
        ...
        CacheService.instance.setRowCacheCapacityInMB(10);
        rowCacheLoad(100, Integer.MAX_VALUE, 1000);

        ColumnFamilyStore store = Keyspace.open(KEYSPACE_CACHED).getColumnFamilyStore(CF_CACHED);
        store.initRowCache();
        assertEquals(100, CacheService.instance.rowCache.getKeySet().size());
        store.cleanupCache();
        assertEquals(100, CacheService.instance.rowCache.getKeySet().size());
        ...
        store.cleanupCache();
        assertEquals(50, CacheService.instance.rowCache.getKeySet().size());
        CacheService.instance.setRowCacheCapacityInMB(0);
    }
