...
public class CommitLogTest extends SchemaLoader
{
    ...
    public void testDontDeleteIfDirty() throws Exception
    {
        ...
        CommitLog.instance.discardCompletedSegments(cfid2, CommitLog.instance.getContext().get(), true);
    ...
    public void testDeleteIfNotDirty() throws Exception
    {
        ...
        CommitLog.instance.discardCompletedSegments(cfid1, CommitLog.instance.getContext().get(), true);

        assert CommitLog.instance.activeSegments() == 1 : "Expecting 1 segment, got " + CommitLog.instance.activeSegments();
        assert CommitLog.instance.activeSegment.isUnused() : "Looks like Commmit log switch didnt happen, CASSANDRA-5911";
