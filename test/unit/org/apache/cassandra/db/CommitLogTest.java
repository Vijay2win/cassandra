...
public class CommitLogTest extends SchemaLoader
{
    ...
    {
        File logFile = File.createTempFile("CommitLog-" + MessagingService.current_version + "-", ".log");
    ...
    {
        Assert.assertTrue(CommitLogSegment.possibleCommitLogFile("CommitLog-1340512736956320000.log"));
        Assert.assertTrue(CommitLogSegment.possibleCommitLogFile("CommitLog-5-1340512736956320000.log"));

        Assert.assertEquals(1340512736956320000L, CommitLogSegment.idFromFilename("CommitLog-5-1340512736956320000.log"));
        Assert.assertEquals(1340512736956320000L, CommitLogSegment.idFromFilename("CommitLog-1340512736956320000.log"));

        Assert.assertEquals(MessagingService.current_version, CommitLogSegment.version("CommitLog-5-1340512736956320000.log"));
        Assert.assertEquals(MessagingService.VERSION_11, CommitLogSegment.version("CommitLog-1340512736956320000.log"));
    }
}
